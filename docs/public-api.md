...
| Live and rolling tables | `live_tables` | `live_data_table.nim`, `csv_viewer.nim` |
...
| CSV and JSON input | `csv_adapter`, `json_adapter` | `csv_viewer.nim`, `data_adapters.nim`, `all_tables.nim` |
